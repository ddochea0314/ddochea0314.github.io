...
date: 2020-08-24
published: true
tags: ['Gridsome', 'Vue', 'Blog', 'Github', 'Github Pages']
series: false
...
맨땅에 헤딩하긴 너무 어려워 Gridsome 공식 Starter인 [gridsome-blog-starter](https://gridsome.org/starters/gridsome-blog-starter/)를 약간 커스터마이징하였습니다. 기본제공하는 Starter는 Lighthouse 올백 맞던데 제가 건드리고나니까 점수가 팍 떨어지네요 (<span class="line-through">역시 똥손</span>)
